...
<body style="background: linear-gradient(to right, #252d80 50%, #41d7eb 100%);">
    ...
    <div class="container-flex">
        <nav class="navbar navbar-expand-lg bg-primary">
            ...
            <a class="navbar-brand text-white" href="{{ route('home.index') }}" >Certamen 3</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" >
                ...
                {{-- poner esto en class en linea 28 @if(Route::current()->getName()=='estudiante.index') active @endif --}}
                <li class="nav-item"> 
